...
function calc_grams() {
  massInput.addEventListener("input", e => {
    ...
    pounds.innerHTML = grams * 0.00220462;
    kilos.innerHTML = grams * 0.001;
    oz.innerHTML = grams * 0.03527;
  });
}
// GRAMS calculation FUNCTION
function calc_kilos() {
  massInput.addEventListener("input", e => {
    ...
    pounds.innerHTML = kilos * 2.20462;
    grams_id.innerHTML = kilos * 1000;
    oz.innerHTML = kilos * 35.274;
  });
}
...
function calc_oz() {
  massInput.addEventListener("input", e => {
    ...
    pounds.innerHTML = oz * 0.0625;
    grams_id.innerHTML = oz * 28.3495;
    kilos.innerHTML = oz * 0.0283495;
  });
}
...
function calc_lbs() {
  massInput.addEventListener("input", e => {
    ...
    kilos.innerHTML = lbs / 0.4535923;
    grams_id.innerHTML = lbs * 453.592;
    oz.innerHTML = lbs * 16;
  });
}
